...
if(isset($data)){
  ...
  $sqlverificarAlumno = " SELECT DNI_alumno  FROM alumno  WHERE DNI_alumno = '$dni_estudiante'; ";
  $queryVerifcarAlumno = mysqli_query($conexion,$sqlverificarAlumno);

  if(mysqli_num_rows($queryVerifcarAlumno)==0){
      //insert a tabla apoderados
